...
/**
 * PATCH /api/registrar/students/[id]
 *
 * Registrar-only endpoint to update student details.
 */
export async function PATCH(req: Request, context: RouteContext) {
  ...
  const rollNumber = normalizeNullableText(body.roll_number);
  ...
  await admin.from("audit_logs").insert({
    ...
    action: "student_updated_by_registrar",
    entity_type: "user",
    entity_id: id,
