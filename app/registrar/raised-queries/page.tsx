...
export default async function RaisedQueriesPage() {
            ...
            <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  View and answer queries raised by students. Your responses will be saved and used to improve future AI answers.
                </p>
              </div>
              <LoadingLinkButton
